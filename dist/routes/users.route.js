...
exports.usersRouter = express_1.default
    ...
    .post('/login', users_controller_js_1.default.login)
...
const adminProtectedRoutes = express_1.default.Router()
    ...
    .get('/', users_controller_js_1.default.getUsers)
    .get('/:user_id', users_controller_js_1.default.getById)
    .post('/admin/register', users_controller_js_1.default.register)
    .put('/assignrole/:user_id', users_controller_js_1.default.assignRole)
    .put('/update/:user_id', users_controller_js_1.default.updateByAdmin)
    .delete('/delete/:user_id', users_controller_js_1.default.delete);
